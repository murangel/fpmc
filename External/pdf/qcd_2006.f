...
cc            write(6,*)'[QCD_2006] Warning: using DPDFs outside range '//
cc     &        ' of validity: z,q2:',z,q2
            write(6,*) '[QCD_2006] Warning: using DPDFs '//
     &       ' outside fitted range ' 
            write(6,*) ' of 0.0043 < z < 0.8 ; 8.5 < Q2 < 1600 '
            write(6,*) ' extrapolation used for z,q2: ',z,q2
            iwarn=iwarn+1
