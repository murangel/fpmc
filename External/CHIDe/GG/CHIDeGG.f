...
C     Transverse energy of the two jets
      Ejet1=sqrt(CHIDedotdiff(k1,k2,k1,k2))
      Ejet2=sqrt(CHIDedotdiff(k2,k3,k2,k3))
...
C   ============================================================================   C
       call CHIDeGGM1(sigmaM1,a1,a2,b1,b2,k1,k2,k3,k,kp) 
       call CHIDeGGM2(sigmaM2,a1,a2,b1,b2,k1,k2,k3,k,kp)
       call CHIDeGGM12(sigmaM12,a1,a2,b1,b2,k1,k2,k3,k,kp)
       call CHIDeGGM12(sigmaM12p,a1,a2,b1,b2,k1,k2,k3,kp,k)
