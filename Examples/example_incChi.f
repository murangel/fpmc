...
C * Inclusive chi_c production at the Tevatron
C----------------------------------------------------------------------- 
      PROGRAM DPECS
c---Common block
...
c---Histograms
      ...
      CALL HBOOK1(103,'Proton 1-xi1    ',100,0.,0.1,0.)
      CALL HBOOK1(104,'Proton 1-xi2    ',100,0.,0.1,0.)
      CALL HBOOK1(105,'Gluon xg1       ',51,0.,1.02,0.)
      CALL HBOOK1(106,'Gluon xg2       ',51,0.,1.02,0.)
      CALL HBOOK1(107,'Central Mass    ',150,0.,15.,0.)
      CALL HBOOK1(108,'Dijet mass      ',150,0.,15.,0.)
      ...
      CALL HBOOK1(304,'Resonance mass',150,0.,15.,0.)
...
C----------------------------------------------------------------------- 
      ...
      REAL ROOTS,CENTM,HARDM,MFRAC,RESMAS
      ...
      XG1=XX(1)!ABS(PHEP(4,8)/PHEP(4,4))
      XG2=XX(2)!ABS(PHEP(4,9)/PHEP(4,6))

      ROOTS=PHEP(4,1)+PHEP(4,2)
      CENTM=ROOTS*SQRT(XI1*XI2)
      HARDM=CENTM*SQRT(XG1*XG2)
      MFRAC=PHEP(5,10)/CENTM
